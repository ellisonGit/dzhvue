<template>
  <div class="noticeList">
    ...
    <div class="recharg">
      ...
      <x-button class="payBut" @click.native="rechargeAmount">确认付款</x-button>
    </div>
  </div>
</template>
        ...
        WeixinJSBridge.invoke(
          ...
          function (res) {
            ...
            if (res.err_msg == "get_brand_wcpay_request:ok") {
              ...
              alert("http://yslduozuhupt.gdeastriver.com/gzh/#/myInfo");
              window.location.href = "http://yslduozuhupt.gdeastriver.com/gzh/#/myInfo"
              /*// 使用以上方式判断前端返回,微信团队郑重提示：
              //res.err_msg将在用户支付成功后返回ok，但并不保证它绝对可靠。
              // 使用以上方式判断前端返回,微信团队郑重提示：
              //res.err_msg将在用户支付成功后返回ok，但并不保证它绝对可靠。
              // window.location.href= "paySuccess.html?trxAmt="+payPrice+"&trxId="+trxId+"&paymentTime="+getDate();
              window.opener = null;
              window.open('', '_self');
              window.close();

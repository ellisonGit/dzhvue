          ...
          <div class='noticeBox' v-for="(item, index) in articleList" :key="index">
            <div class='notices'>
              ...
              <div class='noticeText'>
                ...
                <div class='noticeContent'>{{item.passtime}}</div>
              </div>
            </div>
            <div class='more'>
              <!--                  {{item.clock_id}}-->
...
<script>
  ...
  import {queryPasstimeList} from '@/api/index/index';
  ...
  export default {
    ...
    methods: {
      ...
      getArticleList() {
        ...
        queryPasstimeList(getaData).then(res => {
      ...
      onRefresh(done) {
        ...
        queryPasstimeList(reqData).then(res => {
          const {data, code, message} = res.data;
          const resultData = JSON.parse(data);
          if (code !== 200) {
            this.$vux.toast.show({

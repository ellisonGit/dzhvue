<template>
  <div class="content">
      ...
      <van-pull-refresh v-model="refreshing" @refresh="onRefresh">
        <van-list v-model="loading"
          ...
          <van-cell v-for="(item,index) in list" :key="item.id">
            <van-col span="2"><img src="../assets/images/tabImg/expenditure.png" style="width: 40px"/></van-col>
    ...
    <van-popup v-model="show"
      ...
      <van-cell-group>
        <van-field label="消费日期" :value="date" @click="dateShow = true" readonly
...
<script>
  ...
  import {queryMealRecordsList} from '@/api/index/manager';
  ...
  export default {
    ...
    mounted() {
      ...
      this.queryMealRecordsList(reqData);
    ...
    methods: {
      ...
      onSearch() {
        ...
        this.queryMealRecordsList(data);
        this.show=false;
      },
      ...
      /** 获取消费记录列表 **/
      queryMealRecordsList(reqData) {
        queryMealRecordsList(reqData).then(res => {
